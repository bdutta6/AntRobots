/*
	This class connects a current sensor with via analog pin
        ...
        1/22/2015, removed some variables from the stack and replaced with macros
*/
...
class CurrentSensor
{
    ...
    float ReadAvg(int CURRENT_SAMPLE_SIZE);   	//this will read out an average value in Amperes for a given number of samples
